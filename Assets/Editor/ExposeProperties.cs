    ...
    public static PropertyField[] GetProperties(System.Object obj)
    {
        ...
        foreach (PropertyInfo info in infos)
        {
            ...
            foreach (object o in attributes)
            {
                ...
                else if (o.GetType() == typeof(ReadOnlyAttribute))
                {
                    isReadOnly = true;
                }
            }
            ...
            {
                PropertyField field = new PropertyField(obj, info, type, isReadOnly);
                fields.Add(field);
            }
...
public class PropertyField
{
    ...
    public PropertyField(System.Object instance, PropertyInfo info, SerializedPropertyType type, bool isReadOnly = false)
    {
